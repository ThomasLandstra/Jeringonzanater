...
''' Code has been split into VB Modules,
''' a seperate module of code exists for each tab in the tab control.
...
Public Class formMain
    ...
    ''' </summary>
    ''' <param name="btnSender" type="button">Sender button (unused)</param>
    ''' <param name="e" type="EventArgs">Event arguments (unused)</param>
    ''' <handles>
    '''     btnMod1Check.Click
    ''' </handles>
    Private Sub btnMod1ConvertClick(btnSender As Button, e As EventArgs) Handles btnMod1Convert.Click
    ...
    '''     btnMod2Check.Click
    ''' </handles>
    Private Sub btnMod2CheckClick(btnSender As Button, e As EventArgs) Handles btnMod2Check.Click
    ...
    '''     btnMod3Verify.Click
    ''' </handles>
    Private Sub btnMod3VerifyClick(btnSender As Button, e As EventArgs) Handles btnMod3Verify.Click
    ...
    ''' </handles>
    Private Sub btnMod4ConvertClick(btnSender As Button, e As EventArgs) Handles btnMod4Convert.Click
